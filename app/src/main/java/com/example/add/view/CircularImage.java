...
public class CircularImage extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.circularImage);

        mBorderThickness = a.getDimensionPixelSize(R.styleable.circularImage_border_thickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.circularImage_border_outside_color, defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.circularImage_border_inside_color, defaultColor);
        a.recycle();
    }
